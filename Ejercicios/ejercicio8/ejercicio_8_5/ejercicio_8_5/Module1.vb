Module Module1
    ...
    Sub Main()
        ...
        Do
            MostrarMensaje($"DATOS PERSONA {vbCrLf}", ConsoleColor.Blue)
            persona = New Persona
            ...
            If entrada = "S" Then
                mascota = New Mascota
                MostrarMensaje($"DATOS DE SU MASCOTA {vbCrLf}", ConsoleColor.Blue)
        ...
        MostrarMensaje($"Datos de la persona más joven {vbCrLf}", ConsoleColor.Cyan)
        ...
        If Not IsNothing(_mascotaMasVieja) Then
            MostrarMensaje($"Datos de la mascota más vieja {vbCrLf}", ConsoleColor.Cyan)
